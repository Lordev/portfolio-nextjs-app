			...
			<div className="relative grid bg-primary pt-20 pb-40 lg:pb-60 px-6 text-secondary lg:[clipPath:_polygon(0_0,100%_0%,100%_100%,0_80%)] [clipPath:_polygon(0_0,100%_0%,100%_100%,0_90%)] ">
				<div className="space-y-16 md:grid gap-x-16 md:grid-cols-2 container mx-auto">
					<div className="flex flex-col gap-5 max-w-md">
						...
						<div>
							<p className="">
								Welcome to my front-end showcase! Here, I
								proudly present a selection of my latest
								projects, each crafted with a blend of
								creativity and technical finesse. Through these
								endeavors,{' '}
								<span className="font-semibold">
									I strive to create engaging and immersive
									user experiences that captivate and delight.
								</span>{' '}
								From dynamic animations to responsive layouts,
								each project reflects my commitment to pushing
